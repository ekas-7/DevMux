...
"[project]/app/api/friends/requests/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const requests = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].friendRequest.findMany({
            where: {
...
async function POST(req) {
    try {
        ...
        const request = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].friendRequest.create({
            data: {
                senderEmail: session.user.email,
                receiverEmail
            }
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(request);
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d47377._.js.map